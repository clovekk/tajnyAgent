...
| spi                        | hráč bude do rána spát, pokud je v místnosti s postelemi |
...
Na vhodné spuštění hry se tedy před jejím spuštěním ujistěte, že jste v příkazovém řádku pomocí příkazu cd nastavili složku jar souboru hry \(příklad: "cd C:\Users\Adam\Documents\C2b\IT\tajnyAgent\tajnyAgent-jar" \).
